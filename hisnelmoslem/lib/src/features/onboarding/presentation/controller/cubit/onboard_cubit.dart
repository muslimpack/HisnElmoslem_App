...
//       ),
      const Empty(
        ...
        description: """
- إضافة إمكانية حذف التنبيهات مباشرة من المحرر عبر الضغط المطوّل على أيقونة الجرس.
- يمكنك الآن حذف عدادات السبحة مباشرة من المحرر.
- تحسين نظام تصفية الأذكار المأخوذة من "موطأ مالك" للحصول على تجربة أفضل.
- حل مشكلة ظهور الذكر الأخير في أذكار الصباح والمساء عند تفعيل تصفية مصادر الأذكار.
