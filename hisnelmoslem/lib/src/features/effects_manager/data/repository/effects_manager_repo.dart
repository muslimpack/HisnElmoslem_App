...
class EffectsManagerRepo {
  ...
  Future changeSoundEffectVolume(double value) => box.write(_soundEffectVolumeKey, value);
  ...
  Future changeZikrSoundStatus({required bool value}) => box.write(_isZikrSoundAllowedKey, value);
  ...
  Future changeTitleSoundStatus({required bool value}) => box.write(_isTitleSoundAllowedKey, value);

  ///MARK: Effect Vibration
  /* ******* Effects Vibration ******* */
  ///
  static const _isPraiseVibrationAllowedKey = 'tally_vibrate';
  bool get isPraiseVibrationAllowed => box.read(_isPraiseVibrationAllowedKey) ?? false;
  ...
  int get praiseVibrationDuration => box.read(_praiseVibrationDurationKey) ?? 100;
  ...
  bool get isZikrVibrationAllowed => box.read(_isZikrVibrationAllowedKey) ?? false;
  ...
  bool get isTitleVibrationAllowed => box.read(_isTitleVibrationAllowedKey) ?? false;

  Future changeTitleVibrationStatus({required bool value}) =>
      box.write(_isTitleVibrationAllowedKey, value);

  static const _titleVibrationDurationKey = 'all_azkar_finished_vibrate_duration';
