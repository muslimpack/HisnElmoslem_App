...
- زيادة بسم الله الرحمن الرحيم قبل آية الكرسي فصلا للآية عن الاستعاذة
- ضبط المد في آية الكرسي
- إضافة أواخر آل عمران''',
  ],
  [
    "v2.4.0",
    '''
...
- اضافة خاصية جديدة للسبحة وهي الأذكار المتغيرة بتفعيلها يقوم التطبيق بتبديل عشوائي للأذكار أمامك
...
- حفظ ثيم التطبيق عند أول مرة لفتحة وجعل الوضع المعتم هو الوضع الافتراضي للتطبيق
...
- إضافة  اعدادات الخط إلى صفحة الإعدادات
...
- حل مشكلة عدم حفظ التطبيقات للإعدادات
